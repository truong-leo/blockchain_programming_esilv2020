...
random_hash = hashlib.sha256(str(random_bin).encode('utf-8')).hexdigest()
...
seed_bin = random_bin + random_hash_bin[0:4]
...
lot1_mot = liste_bip_39[int(lot1,2)]
lot2_mot = liste_bip_39[int(lot2,2)]
lot3_mot = liste_bip_39[int(lot3,2)]
lot4_mot = liste_bip_39[int(lot4,2)]
lot5_mot = liste_bip_39[int(lot5,2)]
lot6_mot = liste_bip_39[int(lot6,2)]
lot7_mot = liste_bip_39[int(lot7,2)]
lot8_mot = liste_bip_39[int(lot8,2)]
lot9_mot = liste_bip_39[int(lot9,2)]
lot10_mot = liste_bip_39[int(lot10,2)]
lot11_mot = liste_bip_39[int(lot11,2)]
lot12_mot = liste_bip_39[int(lot12,2)]

print("Voici la liste mnémonique du seed : " + "\n" + lot1_mot + ', ' + lot2_mot + ', ' + lot3_mot + ', ' + lot4_mot + ', ' + lot5_mot + ', ' + lot6_mot + ', ' + lot7_mot + ', ' + lot8_mot + ', ' + lot9_mot + ', ' + lot10_mot + ', ' + lot11_mot + ', ' + lot12_mot)
